/**
 * Utils for G.js, contains useful functions~
 * @author mzhou
 * @version 0.3
 * @log 0.1 init
 *      0.2 add format
 *      0.3 add type ellipsis function
 */


/*jshint undef:true, browser:true, noarg:true, curly:true, regexp:true, newcap:true, trailing:true, noempty:true, regexp:false, strict:true, evil:true, funcscope:true, iterator:true, loopfunc:true, multistr:true, boss:true, eqnull:true, eqeqeq:false, undef:true */
/*global G:false, $:false */

G.def('GUtils', ['jQuery'], function( $ ) {
    'use strict';
    var doc = document,
    ...
    G.ua = (function() {
        var version = parseInt($.browser.version, 10),
            isIE = $.browser.msie && version < 9,
            // NOTE:  这里不再使用(\v1)，因为它不能通过jslint
            isIE6 = isIE && version === 6,
            isIE8 = isIE && version === 8,
            isIE7 = isIE && version === 7,
            isIE9 = $.browser.msie && version === 9,
